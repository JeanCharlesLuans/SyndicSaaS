...
CREATE TABLE MILLIEME 
(
	ID_COPROPRIETE INT NOT NULL, --ID de la cpopropriete
	ID_UTILISATEUR INT NOT NULL, -- Proprietaire du millieme (peut etre un gestionnaire ou un prpriaire)
	VALEUR FLOAT(10,2) NOT NULL -- Valeurs du milieme
);